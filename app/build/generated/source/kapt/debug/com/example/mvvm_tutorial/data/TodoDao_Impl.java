...
public final class TodoDao_Impl implements TodoDao {
  ...
  public TodoDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTodo = new EntityInsertionAdapter<Todo>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `Todo` (`title`,`description`,`isDone`,`id`) VALUES (?,?,?,?)";
      }
  ...
  @Override
  public Object insertTodo(final Todo todo, final Continuation<? super Unit> continuation) {
  ...
  @Override
  public Object deleteTodo(final Todo todo, final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
  ...
  @Override
  public Object getTodoById(final int id, final Continuation<? super Todo> continuation) {
      ...
      public Todo call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _result = new Todo(_tmpTitle,_tmpDescription,_tmpIsDone,_tmpId);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<List<Todo>> getTodos() {
      ...
      public List<Todo> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Todo(_tmpTitle,_tmpDescription,_tmpIsDone,_tmpId);
            _result.add(_item);
          }
          return _result;
        } finally {
